...
class Ticketwidget extends StatelessWidget {
  ...
  const Ticketwidget({super.key,required this.source,required this.destination,required this.Train_class,required this.type
  ,required this.date,required this.train_time,required this.seat,required this.email,required this.price,required this.ticketId,this.onTap});
